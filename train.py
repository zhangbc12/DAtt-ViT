...
def Train(epochs, learning_rate, batchsize, criterion, optmizer, model, device, i):
    ...
    for e in range(epochs):
        ...
        for ind_batch in range(num_batches_val):
            x = data_X[ind_batch * batchsize: (ind_batch + 1) * batchsize]
...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        data_X_train = list_to_tensor(data_X_train, data_Y_train, image_size)
        data_X_val = list_to_tensor(data_X_val, data_Y_val, image_size)
