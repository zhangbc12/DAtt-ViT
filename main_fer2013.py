...
def main(config_path):
    ...
    # model = ViT('B_32_imagenet1k', pretrained=True, image_size=224, num_classes=7)
    from DAtt_Networks.DAtt import DAtt_ViT
    model = DAtt_ViT(pretrained=True, image_size=224, num_classes=7)
...
def get_dataset(configs):
    ...
    test_set = fer2013("test", configs, tta=False, tta_size=10)
...
# tensorboard --logdir="./saved/logs/alexnet__n_2021Apr19_15.07"
