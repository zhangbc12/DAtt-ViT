...
from utils.matrix import confusion
...
class FER2013Trainer(Trainer):
    ...
    def _calc_acc_on_private_test(self):
        ...
        with torch.no_grad():
            ...
            confusion(temp_labels, temp_preds, ['Anger', 'Disgust', 'Fear', 'Happiness', 'Sadness', 'Surprise', 'Normal'],
                      'Normalized confusion matrix of FER2013')
