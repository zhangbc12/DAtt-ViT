"""configs.py - DAtt_Networks model configurations, based on:
https://github.com/google-research/vision_transformer/blob/master/vit_jax/configs.py
"""

def get_base_config():
    """Base DAtt_Networks config DAtt_Networks"""
    return dict(
      dim=768,
      ff_dim=3072,
      num_heads=12,
...
def get_b16_config():
    """Returns the DAtt_Networks-B/16 configuration."""
    config = get_base_config()
    config.update(dict(patches=(16, 16)))
    return config

def get_b32_config():
    """Returns the DAtt_Networks-B/32 configuration."""
    config = get_b16_config()
    config.update(dict(patches=(32, 32)))
    return config

def get_l16_config():
    """Returns the DAtt_Networks-L/16 configuration."""
    config = get_base_config()
    config.update(dict(
        patches=(16, 16),
        dim=1024,
...
def get_l32_config():
    """Returns the DAtt_Networks-L/32 configuration."""
